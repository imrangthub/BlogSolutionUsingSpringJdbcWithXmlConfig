 ...
 <!-- Fixed navbar -->
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p><a class="btn btn-primary btn-lg pull-right" href="/SpringJdbcBlogWithXmlConfig/post/create" role="button">Add new Post</a></p>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12 well">
          ...
          <a class="btn btn-default btn-warning" href="#" role="button">Edit</a>
          <a class="btn btn-default  btn-danger" href="#" role="button">Delete</a>
        </div>
